...
class ElasticsearchService:
    ...
    async def update_dogs(self, results: Dict[str, Any]) -> Dict[str, Any]:
        """Update dogs based on results"""
        return await self._run_in_executor(self.handler.update_dogs, results)